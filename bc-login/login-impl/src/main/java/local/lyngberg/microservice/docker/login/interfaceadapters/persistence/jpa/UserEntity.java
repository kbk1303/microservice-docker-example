...
public class UserEntity {
    ...
    public UserSessionEntity openSession(String sessionToken, LocalDateTime expiresAt) {
        UserSessionEntity session = new UserSessionEntity(this, sessionToken, expiresAt);
        addSession(session);
        return session;
    }

    public boolean closeSessionByToken(String sessionToken) {
        return userSessions.removeIf(session -> session.getSessionToken().equals(sessionToken));
    }
    ...
    public void assignRole(String roleName) {
        ...
        addRole(new UserRoleEntity(this, roleName));
    }
